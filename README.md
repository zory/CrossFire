# CrossFire
Just random small project to see Unity ECS capabilities and how AI can help in development. Two things I always wanted to incorporate.
Decided to write some development updates on some decisions as well just to keep myself motivated. Not worth creating any blog or anything just for that so instead will use my totally empty discord server: https://discord.gg/_REMOVEME_CQZFh7v6XS_REMOVEME_
